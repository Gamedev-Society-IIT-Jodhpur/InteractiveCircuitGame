...
public class ConnectingDiodes : MonoBehaviour
{
   ...
   // Circuit sim;
    ...
    void Start()
    {
       ...
       // sim.Connect(volt0.voltage.leadPos, res1.resistor.leadIn);
        ...
        Sim.sim.Connect(res2.resistor.leadOut,diode.diode.leadIn);
        ...
        Sim.sim.Connect(diode.diode.leadOut,volt0.ACVolt.leadNeg);
        diodeScope = Sim.sim.Watch(diode.diode);
        i=0;
